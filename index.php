...
<head>
    ...
    <title>Aplikasi Nilai by muhamad opan setiawan</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="?m=mapel">Matadiklat</a>
                    </li>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-m2 mb-4">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <span class="float-end">
                    versi 1.0 by <a href="opanstwn.rf.gd" target="blank" rel="noopener noreferrer">muhamad opan
                        setiawan</a>
                </span>
            </div>
        </div>
