                ...
                <form action="?m=santri&s=update" method="post">
                    <div class="mb-3">
                        <input type="text" name="nis" value="<?= $r['nis'] ?>" class="form-control"
                            placeholder="Nomor Induk Santri" required autofocus>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <input type="text" name="dob" value="<?= $r['dob'] ?>" class="form-control"
                            placeholder="Tanggal Lahir">
                    </div>
                    <div class="mb-3">
                    <select name="major_id" class="form-control" requared>
                            <?php
